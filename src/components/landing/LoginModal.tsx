...
import { Button } from "../landing/button"; // adjust this path as needed
...
export function LoginModal({
  ...
  // Corrected useEffect for escape and scroll lock
  useEffect(() => {
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-end">
                    <Link
                      ...
                      className="text-sm text-vibe-purple-400 hover:text-vibe-purple-300 transition-colorsv cursor-pointer"
                    >
                      Forgot Password?
                    </Link>
                  </div>
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full border-gray-700 bg-gray-800 text-white hover:bg-gray-700 py-3 rounded-xl transition-all cursor-pointer"
                  >
