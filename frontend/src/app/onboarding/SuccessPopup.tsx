  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          <div className="flex flex-col items-center space-y-2 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl px-4 py-4 sm:px-6 sm:py-4 sm:flex-row sm:space-y-0 sm:space-x-3 sm:justify-center">
            <div className="mb-2 sm:mb-0 flex-shrink-0">
              <CheckCircle2 className="w-7 h-7 text-vibe-mint-400 mx-auto" />
            </div>
